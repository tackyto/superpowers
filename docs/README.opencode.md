...
To pin a specific version, use a branch or tag. This fork tags its own releases `vX.Y.Z`, and
keeps upstream's tags under `upstream/vX.Y.Z`:
...
- Main documentation: https://github.com/tackyto/superpowers
